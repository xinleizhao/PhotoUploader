...
import hk.hku.cs.common.logger.Log;
import hk.hku.cs.photouploader.BuildConfig;
import hk.hku.cs.photouploader.R;
import hk.hku.cs.photouploader.provider.Images;
import hk.hku.cs.photouploader.util.ImageCache;
import hk.hku.cs.photouploader.util.ImageFetcher;
